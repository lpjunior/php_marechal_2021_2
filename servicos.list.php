                ...
                <table class="table table-stripped" style="color: white;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="servico.edit.php?id=<?= $servico->id ?>"><i class="fa-solid fa-pencil"></i></a>&nbsp;
                                <a onclick="return confirm('Deseja realmente remover este item?')" href="servico.delete.php?id=<?= $servico->id ?>"><i class="fa-solid fa-trash-can"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
