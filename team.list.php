        ...
        <section class="page-section" id="servicos">
            <div class="container">
                ...
                <table class="table table-stripped" style="color: white;">
                    ...
                    <tbody>
                        <?php foreach (listaEquipe() as $team) : ?>
                        <tr>
                            <td><?= $team->id ?></td>
                            <td><?= $team->imagem ?></td>
                            <td><?= $team->nome ?></td>
                            <td><?= $team->cargo ?></td>
                            <td>
                                <a href="team.form.edit.php?id=<?= $team->id ?>"><i class="fa-solid fa-pencil"></i></a>&nbsp;
                                <a onclick="return confirm('Deseja realmente remover este item?')" href="php/team.delete.php?id=<?= $team->id ?>"><i class="fa-solid fa-trash-can"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
