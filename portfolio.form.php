    ...
    <body id="page-top">
        ...
        <section class="page-section" id="forms">
            <div class="container">
                ...
                <form id="formsForm" data-sb-form-api-token="API_TOKEN" method="POST" action="php/portfolio.registrar.php">
                    <div class="row align-items-center mb-5 offset-4">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <!-- Subtitle input-->
                                <input class="form-control" id="subtitle" name="inputSubtitulo" type="text" placeholder="Informe o subtitulo *" data-sb-validations="required" />
